  ...
  implements BluetoothService
{
	...
	public void processGattServices(List<BluetoothGattService> services)
	{
		for (BluetoothGattService service : services)
			if (StrideAwareUuid.BEACON_ALERT.equals(service.getUuid())) {
				
				if (service.getCharacteristic(StrideAwareUuid.BEACON_ALERT_CHAR) != null)
				{
					this.characteristics.put(StrideAwareUuid.BEACON_ALERT_CHAR, service.getCharacteristic(StrideAwareUuid.BEACON_ALERT_CHAR));	
				}
			}
	}
