...
import com.strideaware.sdk.connection.StrideAwareDefine;
import com.strideaware.sdk.internal.HashCode;
import com.strideaware.sdk.internal.Preconditions;
/**
...
//	   return (0.103D + 0.89978D * Math.pow(ratio, 7.71D)) * rssiCorrection;
     ...
     if (RSSI == 0.0D) {
   	...
   	public static int proximityFromAccuracy(double accuracy)
   	{
   		if (accuracy < 0.0D) 
   		{
   			return StrideAwareDefine.StridAware_BEACON_PROXIMITY_STATE_UNKNOWN;
   		}
   		if (accuracy < 0.5D) 
   		{
   			return StrideAwareDefine.StridAware_BEACON_PROXIMITY_STATE_IMMEDIATE;
   		}
   		if (accuracy <= 3.0D) {
   			return StrideAwareDefine.StridAware_BEACON_PROXIMITY_STATE_NEAR;
   		}
   		return StrideAwareDefine.StridAware_BEACON_PROXIMITY_STATE_FAR;
   }
